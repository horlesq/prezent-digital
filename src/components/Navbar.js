...
export const NavItems = ({ items, className, onItemClick }) => {
    ...
    return (
        <motion.div
            ...
            className={cn(
                "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-neutral-600 dark:text-neutral-300 transition duration-200 hover:text-neutral-900 dark:hover:text-neutral-50 lg:flex lg:space-x-2",
                className
            )}
        >
            {items.map((item, idx) => (
        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className={cn(
                        "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-white dark:bg-neutral-900 px-4 py-8 shadow-[0_0_24px_rgba(34,42,53,0.06),0_1px_1px_rgba(34,42,53,0.05),0_0_0_1px_rgba(34,42,53,0.04),0_0_4px_rgba(34,42,53,0.08),0_16px_68px_rgba(34,42,53,0.05),0_1px_0_rgba(255,255,255,0.1)_inset]",
                        className
                    )}
                >
                    {children}
...
export const NavbarButton = ({
    ...
    const baseStyles =
        "px-4 py-2 rounded-md bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-50 text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
