export const CONTENT = {
    hero: {
        ...
        cta: {
            primary: "Pornește-ți proiectul acum",
            secondary: "Vezi Portofoliu",
        },
        features: [
    ...
    footer: {
        companyName: "Prezent Digital",
        tagline:
            "Transformăm ideile în soluții digitale de impact. Partenerul tău de încredere în dezvoltarea online.",
        quickLinks: "Meniu Rapid",
        links: [
            { href: "/", label: "Acasă" },
